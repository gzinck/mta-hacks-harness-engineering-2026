      ...
      <div className="rules-layout">
        <div className="rules-file">
          <div className="rules-file__header">
            <span className="rules-file__dot" style={{ background: '#f87171' }} />
            <span className="rules-file__dot" style={{ background: '#fbbf24' }} />
            <span className="rules-file__dot" style={{ background: '#4ade80' }} />
