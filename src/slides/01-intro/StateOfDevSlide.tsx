...
const events = [
  { date: 'May 2025', pos: pct('2025-05-01'), label: 'Claude Sonnet / Opus 4', company: 'anthropic', above: true  },
  { date: 'Aug 2025', pos: pct('2025-08-01'), label: 'GPT-5',                  company: 'openai',    above: false },
  { date: 'Nov 2025', pos: pct('2025-11-01'), label: 'Claude Opus 4.5',        company: 'anthropic', above: true  },
  { date: 'Dec 2025', pos: pct('2025-12-01'), label: 'GPT-5.2',                company: 'openai',    above: false },
  { date: 'Mar 2026', pos: pct('2026-03-11'), label: 'Sonnet / Opus 4.6\nGPT-5.4', company: 'both', above: true, today: true },
]
...
export function StateOfDevSlide() {
  ...
  return (
    <SlideLayout>
      <SlideTitle tag="01 · Intro" title="The State of Development" subtitle="March 2026" />
      ...
      <div className="tl-stage">
          ...
          return (
            ...
            >
              ...
              <span className="tl-label__name">
                {ev.label.split('\n').map((line, j) => (
                  <span key={j} className="tl-label__line">{line}</span>
                ))}
              </span>
        ...
        <div className="tl-track">
          <div className="tl-fill tl-fill--hand" style={{ width: `${ERA_SPLIT}%` }} />
          <div className="tl-fill tl-fill--ai"   style={{ left: `${ERA_SPLIT}%`, right: 0 }} />

          {focused !== null && (
            <div className="tl-progress" style={{ width: `${events[focused].pos}%` }} />
          )}
        ...
        <div className="tl-era tl-era--ai" style={{ left: `${ERA_SPLIT}%`, right: 0 }}>
